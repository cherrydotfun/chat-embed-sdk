...
export const PRESETS: ThemePreset[] = [
  ...
  },
  {
    id: 'solflare',
    label: 'Solflare',
    blurb: 'Solar flare — orange→yellow gradient on warm dark, indigo accents.',
    swatches: ['#FF9340', '#FFEF46'],
    theme: {
      mode: 'dark',
      primaryColor: '#FF9340',
      accentColor: '#FFEF46',
      ...
      linkColor: '#FF9340',
      linkColorOwn: '#3a2400',
      incomingBubbleColor: '#241F3D',
      incomingBubbleBorderColor: '#3D38C0',
      // ownBubbleColor + sendButtonColor stay UNSET on purpose — the iframe
      // paints its primary→accent gradient, i.e. the orange→yellow flare.
      ownBubbleTextColor: '#2a1800',
      headerColor: '#17131D',
      headerTextColor: '#ffffff',
      inputColor: '#17131D',
      inputTextColor: '#ffffff',
      sendButtonTextColor: '#2a1800',
      ownEmbedBgColor: '#E0832E',
      otherEmbedBgColor: '#322C55',
      messageActionsColor: '#1E1A24',
      messageActionsTextColor: '#ffffff',
      tooltipColor: '#0C0A10',
      tooltipTextColor: '#ffffff',
      emojiPickerColor: '#1E1A24',
      avatarHoverColor: 'rgba(255, 255, 255, 0.06)',
      loaderColor: '#FF9340',
      messageOwnAccentColor: '#FFB45E',
      messageOwnAccentSoftColor: '#FFE08A',
      messageOtherAccentColor: '#5A52C8',
      messageOtherAccentSoftColor: '#B9B4F0',
      iconButtonColor: '#8A8694',
      iconButtonHoverColor: '#FFEF46',
      modalOverlayColor: 'rgba(0, 0, 0, 0.6)',
      dangerColor: '#FF5A5A',
      gmColor: '#FFEF46',
      roleBadgeColor: '#FF9340',
